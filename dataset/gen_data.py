...
gfile = tf.compat.v1.gfile# tf.gfile
FLAGS = flags.FLAGS

DATASETS = [
    'kitti_raw_eigen', 'kitti_raw_stereo', 'kitti_odom', 'cityscapes', 'bike', 'nyu'
]
...
def _generate_data():
  ...
  if FLAGS.dataset_name == 'bike':
    ...
    dataloader = dataset_loader.Cityscapes(FLAGS.dataset_dir,
                                           ...
                                           img_width=FLAGS.img_width,
                                           seq_length=FLAGS.seq_length)
  elif FLAGS.dataset_name == 'nyu':
    dataloader = dataset_loader.NYURaw(FLAGS.dataset_dir,
                                         split='eigen',
                                         img_height=FLAGS.img_height,
                                         img_width=FLAGS.img_width,
                                         seq_length=FLAGS.seq_length)
